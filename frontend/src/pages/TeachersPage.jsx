...
//   const [formData, setFormData] = useState({ name: "", subject: "", class: "", section: "" });
...
//     if (!formData.name || !formData.subject || !formData.class || !formData.section) return;
//     try {
...
//     try {
//       await axios.put(`http://localhost:3000/api/teachers/${editingTeacher._id}`, formData);
...
//       t.section.toLowerCase().includes(search.toLowerCase()); // ✅ include section in search

//     // const matchesClass = filterClass ? t.class === filterClass : true;
//     // const matchesClass = filterClass ? t.class.toLowerCase() === filterClass.toLowerCase() : true;
//     const matchesClass = filterClass
//     ? t.class.toLowerCase().replace(/\s+/g, "") ===
...
//         <h2 className="text-xl font-semibold mb-3">{editingTeacher ? "Edit Teacher" : "Add New Teacher"}</h2>
...
//             </button>
//             <button
//               onClick={() => { setEditingTeacher(null); setFormData({ name: "", subject: "", class: "", section: "" }); }}
...
//         <th className="p-2">#</th><th className="p-2">Name</th><th className="p-2">Subject</th><th className="p-2">Class</th><th className="p-2">Section</th><th className="p-2 text-center">Actions</th>
//       </tr>
//     </thead>
//     <tbody>
//       {filteredTeachers.map((t, i) => (
//         <tr key={t._id} className="border-b hover:bg-gray-50">
//           <td className="p-2">{i + 1}</td><td className="p-2">{t.name}</td><td className="p-2">{t.subject}</td><td className="p-2">{t.class}</td><td className="p-2">{t.section}</td>
//           <td className="p-2 text-center flex gap-2">
//             <button onClick={() => openEditModal(t)} className="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600">Edit</button>
//             <button onClick={() => deleteTeacher(t._id)} className="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600">Delete</button>
//           </td>
//         </tr>
//       ))}
//     </tbody>
